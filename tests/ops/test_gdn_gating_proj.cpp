...
int main() {
    ...
    // sides of each route boundary: sm_86 (768/769, 1664/1665, 3456/3457) and sm_120
    // (1024/1025, 2048/2049, 4096/4097).
    for (const std::int32_t tokens : {1, 8, 9, 768, 769, 1024, 1025, 1664, 1665, 2048, 2049, 3456,
                                      3457, 4096, 4097}) {
